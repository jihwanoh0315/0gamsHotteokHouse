...
public class DoughManager : MonoBehaviour
{
        ...
        if (!isFinished)
        {
            ...
            || limitTimer < 0.0f)
            {
                ...
                if (!isTwo)
                {
                    ...
                    currTime = 0.0f;
                    limitTimer = timeLimit;
                    if (levelSetting.activeFoods[0] == true) //greentea
                    {
                    ...
                    else if (levelSetting.activeFoods[1] == true) // sweetPotato
                    {
                        isTwo = true;
                        lastDough = 2;
                        normalDough.SetActive(false);
    ...
    void FinishDough()
    {
        ...
        levelSetting.doughScore[lastDough] = doughInfo[lastDough].doughScore;
        if (isTwo)
        {
